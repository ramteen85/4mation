...
<html lang="en" style="height:100%;">
    ...
    <![endif]-->         
        ...
        <link href="eprofile.css" rel="stylesheet" type="text/css">
    </head>     
    <body data-spy="scroll" data-target="nav">
        <section id="cb-contact-1-1" class="cb-contact-block cb-contact-1-1">
            <div id="contact1"> 
                <div class="container"> 
                    <h3 class="editContent" style="outline: none; cursor: inherit;">Edit Profile</h3> 
                        ...
                        <div id="pbox1" class="col-sm-12"> 
                            <form action="#"> 
                                ...
                                <div class="col-md-12 col-sm-12"> 
                                    <textarea name="message" class="form-control textarea" placeholder="Please tell us a bit about yourself..."></textarea>                                     
                                </div>
