...
<html lang="en" style="height:100%;">
    <head> 
        ...
        <meta charset="utf-8"> 
        <title>4Mation | Admin Tasks and Announcements Options</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0"> 
        <meta name="keywords" content="pinegrow, blocks, bootstrap" />
        <meta name="description" content="4Mation Technologies Employee Management Systemn | Admin Tasks and Announcements Options" />
