...
<html lang="en" style="height:100%;">
    <head> 
        ...
        <meta name="description" content="4Mation Technologies Employee Management Systemn | Teams" />
        <!-- Core CSS -->         
        <!-- Style Library -->         
    ...
    <body data-spy="scroll" data-target="nav">
        ...
        <section id="cb-intro-1-5" class="cb-intro-block cb-intro-1-5" data-pg-collapsed>
            <div id="intro5" class="teamimg"> 
                <div class="overlay"></div>                 
                <div class="container" data-pg-collapsed> 
                    <h3 class="editContent mb20 cleanup"> <span class="rectangle">Teams</span></h3> 
                    <p class="editContent cleanup">This is the teams page. Here, You will be able to view all the current teams that are listed and all the members of that team. Please keep in mind that our admins choose the teams and will allocate you to one if you have a new account, but you cannot select the team yourself. When you are allocated in your team, this will be indicated at the top of your profile and in the statistics section of the members area.</p> 
                </div>                 
            </div>
        </section>
        ...
        <section id="cb-header-1-6" class="cb-header-block cb-header-1-6" data-pg-collapsed>
            <header id="header6" class="teamimg2"> 
</header>             
        </section>
                ...
                <div class="container"> 
                    <div class="row"> 
                        <div class="col-sm-offset-1 col-sm-10"> 
                            <h1 class="text-center teamheader">List of Teams</h1> 
                        </div>                         
                    </div>
                    <div class="row" data-pg-collapsed> 
                        ...
                        <div class="col-sm-4" data-pg-collapsed> 
                            <div style="background: #095880;" class="feautures-box"> 
                                <div class="icon editContent cleanup">
