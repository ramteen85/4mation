...
<html lang="en" style="height:100%;">
    ...
    <section id="cb-utility-1-1" class="cb-utility-block cb-utility-1-1" data-pg-collapsed>
        <div class="page404-1"> 
            <div class="container"> 
                <div class="image-404"> 
                    <img alt="caption" src="/images/ohno.png" style="outline: none; cursor: inherit; width: 100%" class="text-center"> 
                </div>                         
                <h1 class="editContent errorhead" style="outline: none; cursor: inherit;">404</h1> 
                <p class="editContent" style="outline: none; cursor: inherit;">The message does not exist or you are not allowed to access it.</p> 
                <div class="text-center"> 
                    <a href="/" class="btn btn-default-transparent editContent">Go Home</a> 
                </div>
            </div>                     
        </div>                 
    </section>
